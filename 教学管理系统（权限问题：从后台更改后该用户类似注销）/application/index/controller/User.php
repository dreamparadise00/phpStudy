...
class User extends Base
{
    ...
    public function login()
    {
        ...
        $this -> view -> assign('keywords', 'Paradise_追逐者');
        $this -> view -> assign('desc', '教学管理系统');
        $this -> view -> assign('copyRight', '本案例由Paradise_追逐者开发，欢迎二次开发');
    ...
    public function  adminList()
    {
        ...
        $this -> view -> assign('keywords', '教学系统系统');
    ...
    public function adminEdit(Request $request)
    {
        ...
        $this->view->assign('desc','教学管理系统 Paradise_追逐者');
